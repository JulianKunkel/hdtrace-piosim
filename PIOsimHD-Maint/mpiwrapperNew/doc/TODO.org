...
** TODO Struktur umstellen
** TODO clean getFileIdEx
** TODO set_view loggen -> datentyp
** TODO Endtags!
** TODO Datei-Dupletten beseitigen
** DONE stephans filewriter verwenden
** TODO merger ordentlich machen + dokumentieren
** TODO topologie ändern (merger, writer)
   -> Projektname trace_mpi-io-test_hostname_rank_thread_

** TODO threads testen
** TODO eigene tests dokumentieren, am besten vollautom. test
** TODO überall datentyp rausschreiben
** TODO trace-dateinamen normalisieren
** TODO project-description-merger
*** TODO Refactor
*** TODO DARRAY ausgabe: MPI-Knostanten ordentlich loggen (MPI_DISTRIBUTE_BLOCK...)

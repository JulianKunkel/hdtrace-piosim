...
*** TODO Split-collective-Aufrufe
    ...
    ----------------------------------
    ist das in Ordnung? 
*** TODO Rufen die PMPI_* - Funktionen wieder MPI_* auf? 
...
** TODO HDTraceWriter implementieren
*** 
...
** TODO Das absolutes-seek-file-offst-Problem
...
** TODO "Fix Memleak" klären (MPI_Finalize, hashmaps löschen)

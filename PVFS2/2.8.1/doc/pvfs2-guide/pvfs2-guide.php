...
<LI><A NAME="tex2html57"
  HREF="pvfs2-guide.php">1 An introduction to PVFS2</A>
<UL>
...
<LI><A NAME="tex2html93"
  HREF="pvfs2-guide.php#SECTION00080000000000000000">About this document ...</A>
</UL>
...
1.2.1 Modular networking and storage</A>
</H3>
...
popular ones at the time of writing, but surely more will appear <I>and
disappear</I> in the near future.
...
1.2.2 Structured non-contiguous data access</A>
</H3>
...
1.2.3 Flexible data distribution</A>
</H3>
...
many cases we <I>do</I> know more about how a file is going to be accessed.
...
1.2.5 Stateless servers and clients</A>
</H3>
...
1.2.6 Explicit support for concurrency</A>
</H3>
...
1.2.8 Flexible mapping from file references to servers</A>
</H3>
...
<P>
In PVFS2 file data is split into <I>datafiles</I>.  Each datafile has its own
...
files, and remove files may all be performed in this same <IMG
...
1.2.10 Data and metadata redundancy</A>
</H3>
...
<P>
A second option that is being investigated is what we are calling <I>lazy
redundancy</I>.  The lazy redundancy approach is our response to the failure of
...
1.3 When will this be available?</A>
</H2>
...
<P>
There are lots of things that PVFS2 is <I>not</I> designed for.  In some cases
...
<P>
PVFS2 uses an <I>intelligent server</I> architecture.  By this we mean that
...
An alternative architecture is <I>shared storage</I>, where storage devices
...
<P>
In PVFS1 there were two types of server processes, <I>mgrs</I> that served
metadata and <I>iods</I> that served data.  For any given PVFS1 file system
there was exactly one active mgr serving metadata and potentially many
<I>iods</I> serving data for that file system.  Since mgrs and iods are just
...
<P>
In PVFS2 there is exactly one type of server process, the <I>pvfs2-server</I>.
...
client-side UNIX process, the <I>pvfsd</I>, handles interactions with servers.
A more efficient in-kernel version called <I>kpvfsd</I> was later provided as
well.
...
where a UNIX process, the <I>pvfs2-client</I>, handles interactions with
...
2.4 Client-server interactions</A>
</H2>
...
<I>handle</I>, through a lookup operation.  Given a handle to some file, any
...
2.5 Consistency from the client point of view</A>
</H2>
...
to add additional latency to the system and are often <I>extremely</I>
...
view.  Clients perform sequences of steps (called <I>server requests</I>) that
...
4 PVFS2 internal I/O API terminology</A>
</H1>
...
works on top of Trove (<I>currently unused</I>)
</LI>
...
of <I>any</I> operations that have previously been posted, regardless of the 
...
4.7 Time outs and max idle time</A>
</H2>
...
<A NAME="sec:apis"></A>
<BR>
5 PVFS2 User APIs and Semantics
</H1>
...
name to convert it into a <I>handle</I> that can be used for subsequent read
...
5.1.2 Permissions and File Access</A>
</H3>
...
5.1.3 Access to Removed Files</A>
</H3>
...
<P>
<I> Neill: Is this completely true, or do clients delay removal in
  pvfs2-client if someone is still accessing? </I>

<P>

<H3><A NAME="SECTION00061400000000000000">
5.1.4 Overlapping I/O Operations</A>
</H3>
...
<P>
In PVFS2 we instead implement a semantic we call <I>nonconflicting writes</I>
...
5.2.2 MPI-IO Shared Pointer Mode</A>
</H3>
...
protocol.  Currently the ``encoding scheme'' used is the <I>contig</I>
...
directory because it is hooked under the <I>job</I> component.
...
responsible for ferrying data between different types of <I>endpoints</I>.
...
6.5 State machines and <TT>statecomp</TT></A>
</H2>
...
The command line arguments were: <BR>
 <STRONG>latex2html</STRONG> <TT>-split 0 -show_section_numbers -nonavigation -init_file /tmp/pvfs-2.8.1/doc/latex2html-init pvfs2-guide.tex</TT>
<P>

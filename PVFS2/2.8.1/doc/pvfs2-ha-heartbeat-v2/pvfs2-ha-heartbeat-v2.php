...
<LI><A NAME="tex2html31"
  HREF="pvfs2-ha-heartbeat-v2.php">1 Introduction</A>
...
<LI><A NAME="tex2html56"
  HREF="pvfs2-ha-heartbeat-v2.php#SECTION000150000000000000000">About this document ...</A>
</UL>
...
<IMG
 ...
 SRC="img1.png"
 ALT="$\lceil ((N/2)-1) \rceil$"> node failures, where N is
...
<I>not</I> use the primary IP address of each node for this purpose.
...
6 Distributing Heartbeat scripts</A>
</H1>
...
7 Base Heartbeat configuration</A>
</H1>
...
11 What happens during failover</A>
</H1>
...
The command line arguments were: <BR>
 <STRONG>latex2html</STRONG> <TT>-split 0 -show_section_numbers -nonavigation -init_file /tmp/pvfs-2.8.1/doc/latex2html-init pvfs2-ha-heartbeat-v2.tex</TT>
<P>

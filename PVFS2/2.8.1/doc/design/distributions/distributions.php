...
This is refered to here as a <I>logical offset</I>.  A contiguous
...
start of the byte stream referred to here as a <I>physical offset</I>.
...
2 System Interface Distributions</A>
</H1>
...
specified, the default distribution <I>simple_stripe</I> is used during
...
<P>
Set the distribution parameter specified by the string <I>param</I> to
<I>value</I>.  The strings used to specify parameters are distribution defined
...
3 Distribution Initialization</A>
</H1>
...
method named <I>register_init</I> that is called during registration.  The
...
4 Internal Distribution Representation</A>
</H1>
...
<P>
Set the distribution parameter described by <I>param_name</I> to
<I>value</I>.  A default implementation is provided in pint-dist-utils.h that
...
<P>
Write <I>params</I> into the data stream pptr in little endian byte format.
...
<P>
Read <I>params</I> from the data stream pptr in little endian byte format.

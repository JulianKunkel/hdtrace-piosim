...
2 Entities on Physical Storage</A>
</H1>
...
3 Hooking to Upper Trove Layer</A>
</H1>
...
<P>
<I>Additionally a method ID is passed in...why???</I>
...
6 Keyval Spaces Implementation</A>
</H1>
...
function left off. The iterator function will process <I>count</I> items per
call: if fewer than <I>count</I> items are left in the database, we set
<I>count</I> to how many items were processed.  The caller should check that
<I>count</I> has the same value as before the function was called. 

<P>

<H1><A NAME="SECTION00070000000000000000">
7 Bytestreams Implementation</A>
</H1>
...
8.1 Creating a Storage Space</A>
</H2>
First a storage space must be created.  Storage spaces are created with the
storage_create mgmt operation.  <I>This function can be used without calling the
initialize function?</I>  This function creates the storage attributes database
and the collections database.

<P>

<H2><A NAME="SECTION00082000000000000000">
8.2 Creating a Collection</A>
</H2>
...
<P>
<I> The collection lookup routine opens the collection attribute database and
finds the root handle.  This really isn't right...the collection routines
don't need to know about this...the fs routines should instead.</I>
...
8.3 Creating a Root Directory</A>
</H2>
...
<I>Currently this code will not try to come up with a new handle if the
proposed one is used...fix?</I>

<P>
An entry is placed in the dataspace attribute DB for the collection.

<P>
<I>What is the ``type'' field used for?</I>

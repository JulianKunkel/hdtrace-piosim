...
<P>
We will define <I>overlapping writes</I> to be concurrent writes that modify
the same bytes in an object.  We will define <I>interleaved writes</I> to be
...
<P>
<I>Note: we're not counting on inter-server communication at this time.</I>

<P>

<H2><A NAME="SECTION00031000000000000000">
3.1 Permissions and permission checking</A>
</H2>
...
3.2 Removing an object that is being accessed</A>
</H2>
...
3.6 Top level scheduler semantics</A>
</H2>
...
4 Client-side library without locks or inter-client communication</A>
</H1>
...
<P>
<I>Note the operations at this level</I>
...
<P>
<I>Do we want some kind of optional data caching?  If so, this changes our
concurrent write model.</I>

<P>

<H2><A NAME="SECTION00041000000000000000">
4.1 Caching of file and directory attributes</A>
</H2>
...
4.2 Caching of directory hierarchy</A>
</H2>
...
<P>
<I> Any time a request is received on a client to operate on a file system
object that is not known to the client-side cache, the client will attempt to
retrieve metadata for the object.</I>

<P>

<H2><A NAME="SECTION00045000000000000000">
4.5 Concurrent, byte-overlapping writes to a single file</A>
</H2>
...
<P>
<I>Concurrent, non-overlapping writes will result in the
...
<P>
<I>We will implement the dirent second scheme.</I>
...
<P>
<I>Need to handle the create/move in some way.  How?</I>
...
4.8 Deleting a file that is being accessed</A>
</H2>
...
4.9 Permissions and permission checking</A>
</H2>
...
4.10 Readdir with concurrent directory changes</A>
</H2>
...
5.1 Implementing<TT>O_APPEND</TT> with and without concurrent access</A>
</H2>
...
5.2 Permissions and permission checking</A>
</H2>
...
6.2 Migrating files and changing distributions</A>
</H2>

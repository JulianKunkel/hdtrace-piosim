...
3.1 Installing the Operating System</A>
</H2>
...
<LI>Put the PowerVault enclosure in <I>cluster mode</I>.  To do so,
...
<LI>Instead of using the command-line tools, configure through the
 ...
 SRC="img1.png"
 ALT="$\rightarrow$"> Adapter <IMG
 WIDTH="22" HEIGHT="16" ALIGN="BOTTOM" BORDER="0"
 SRC="img1.png"
 ALT="$\rightarrow$"> Cluster Mode <IMG
 WIDTH="22" HEIGHT="16" ALIGN="BOTTOM" BORDER="0"
 SRC="img1.png"
 ALT="$\rightarrow$">
 ...
 WIDTH="22" HEIGHT="16" ALIGN="BOTTOM" BORDER="0"
 SRC="img1.png"
 ALT="$\rightarrow$"> Adapter menu too.  See the manual for more things you
...
3.3.1 ACTIVE-PASSIVE (A-P)</A>
</H3>

<P>
The two nodes are configured as in Figure&nbsp;<A HREF="pvfs2-ha.php#fig:nodes">1</A>.  They have a
...
<DIV ALIGN="LEFT">
<IMG
 WIDTH="329" HEIGHT="376" ALIGN="BOTTOM" BORDER="0"
 SRC="img2.png"
...
Figure&nbsp;<A HREF="pvfs2-ha.php#fig:haconfig">2</A>, Figure&nbsp;<A HREF="pvfs2-ha.html#fig:haresources">3</A>, and
Figure&nbsp;<A HREF="pvfs2-ha.php#fig:authkeys">4</A> for examples.
...
other</CAPTION>
<TR><TD><IMG
 WIDTH="556" HEIGHT="328" BORDER="0"
 SRC="img6.png"
 ALT="\begin{figure}\begin{scriptsize}
\begin{verbatim}eth0 Link encap:Ethernet HWad...
...es:156677942 (149.4 MiB)
Interrupt:29\end{verbatim}\end{scriptsize}\end{figure}"></TD></TR>
</TABLE>
</DIV>
...
interface bound to the cluster ip (see Figure&nbsp;<A HREF="pvfs2-ha.php#fig:alias">5</A>), the file system mounted, and the
...
haresources file in Figure&nbsp;<A HREF="pvfs2-ha.php#fig:haresources">3</A>, the output of
<TT>ifconfig</TT> should still look like Figure&nbsp;<A HREF="pvfs2-ha.php#fig:alias">5</A>, you
...
<DIV ALIGN="LEFT">
<IMG
 WIDTH="329" HEIGHT="360" ALIGN="BOTTOM" BORDER="0"
 SRC="img7.png"
...
for a (hopefully rare) failure.   Figure&nbsp;<A HREF="pvfs2-ha.php#fig:nodes-aa">6</A> depicts an
...
in both scripts.  See Figure&nbsp;<A HREF="pvfs2-ha.php#fig:init">7</A> and
Figure&nbsp;<A HREF="pvfs2-ha.php#fig:init-other">8</A>.
...
Figure&nbsp;<A HREF="pvfs2-ha.php#fig:haresources-aa">9</A>.
...
Figure&nbsp;<A HREF="pvfs2-ha.php#fig:ifconfig-aa">10</A> shows node A after node B goes down.  Node A
...
addresses .</CAPTION>
<TR><TD><IMG
 WIDTH="579" HEIGHT="404" BORDER="0"
 SRC="img11.png"
 ALT="\begin{figure}\begin{scriptsize}
\begin{verbatim}eth0 Link encap:Ethernet HWad...
...es:158334802 (150.9 MiB)
Interrupt:29\end{verbatim}\end{scriptsize}\end{figure}"></TD></TR>
</TABLE>
</DIV>
...
The command line arguments were: <BR>
 <STRONG>latex2html</STRONG> <TT>-split 0 -show_section_numbers -nonavigation -init_file /tmp/pvfs-2.8.1/doc/latex2html-init pvfs2-ha.tex</TT>
<P>

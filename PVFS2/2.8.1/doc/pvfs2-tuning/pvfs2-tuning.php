...
<LI><A NAME="tex2html36"
  HREF="pvfs2-tuning.php">1 Introduction</A>
...
<LI><A NAME="tex2html64"
  HREF="pvfs2-tuning.php#SECTION000120000000000000000">About this document ...</A>
</UL>
...
How many IO servers? <A NAME="tex2html1"
  HREF="#foot14"><SUP>1</SUP></A>How many MD servers?
Should IO and MD servers be shared?

<P>

<H2><A NAME="SECTION00042000000000000000">
3.2 Local File System</A>
</H2>
...
4.2.1 Kernel Parameters</A>
</H3>

<H3><A NAME="SECTION00052200000000000000">
4.2.2 Socket Buffer Sizes</A>
</H3>

<H3><A NAME="SECTION00052300000000000000">
4.2.3 Listening Backlog (?)</A>
</H3>
...
5.1 Maximum I/O Size</A>
</H2>

<P>

<H2><A NAME="SECTION00062000000000000000">
5.2 Workload Specifics</A>
</H2>

<P>

<H1><A NAME="SECTION00070000000000000000">
6 Number of Datafiles</A>
</H1>
...
<I>datafiles</I> distributed among multiple servers.
...
<P>
A <I>distribution</I> is an algorithm that defines how a file's data
...
<P>
The only tuning parameter within simple stripe is the <I>strip size</I>.
...
<I>incast</I>.  Incast occurs when a client requests a range of data that
...
<I>strips</I> parameter, which specifies the strip size for each server.
...
<IMG
 ...
 SRC="img1.png"
 ALT="$&lt;server&gt;:&lt;strip size&gt;$"> pairs.  The strip size can be specified with short hand
...
The command line arguments were: <BR>
 <STRONG>latex2html</STRONG> <TT>-split 0 -show_section_numbers -nonavigation -init_file /tmp/pvfs-2.8.1/doc/latex2html-init pvfs2-tuning.tex</TT>
<P>
The translation was initiated by Samuel Lang (ANL) on 2009-03-02
<BR><HR><H4>Footnotes</H4>
<DL>
<DT><A NAME="foot14">... servers?</A><A
 HREF="pvfs2-tuning.php#tex2html1"><SUP>1</SUP></A></DT>

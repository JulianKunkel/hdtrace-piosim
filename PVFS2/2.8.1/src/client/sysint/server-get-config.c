...
static struct PINT_state_s ST_run_fetch_nested;
static struct PINT_pjmp_tbl_s ST_run_fetch_nested_pjtbl[];
static struct PINT_tran_tbl_s ST_run_fetch_nested_trtbl[];

static PINT_sm_action server_fetch_config_parent_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_parent_fetch_cleanup;
static struct PINT_pjmp_tbl_s ST_parent_fetch_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_parent_fetch_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_server_fetch_config_sm = {
	.name = "pvfs2_server_fetch_config_sm",
	.first_state = &ST_run_fetch_nested
};

static struct PINT_state_s ST_run_fetch_nested = {
	 .state_name = "run_fetch_nested" ,
	 .parent_machine = &pvfs2_server_fetch_config_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_server_fetch_config_nested_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_run_fetch_nested_trtbl 
};

static struct PINT_tran_tbl_s ST_run_fetch_nested_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_parent_fetch_cleanup }
};

static struct PINT_state_s ST_parent_fetch_cleanup = {
	 .state_name = "parent_fetch_cleanup" ,
	 .parent_machine = &pvfs2_server_fetch_config_sm ,
	 .flag = SM_RUN ,
	 .action.func = server_fetch_config_parent_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_parent_fetch_cleanup_trtbl 
};
...
# 116 "src/client/sysint/server-get-config.sm"

...
public interface ISSwitch {
	public void newMessagePartReceived(MessagePart msg);
	public NetworkComponent getRoutingTarget(MessagePart msg);
	public Epoch getProcessingTime(MessagePart msg);
}

...
/**
 * MPICH2 alike Implementation, first a Scatter operation is invoked, then the data is gathered with the gatherall implementation.
 */
public class BroadcastScatterGatherall
extends CommandImplementation<Bcast>
{
	...
	public void process(Bcast cmd, CommandProcessing OUTresults, GClientProcess client, long step, NetworkJobs compNetJobs)
	{
		...
		if(step == CommandProcessing.STEP_START){
			...
			OUTresults.invokeChildOperation(scmd, SCATTER_COMPLETED, null);

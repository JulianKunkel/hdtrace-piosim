...
public class STauTraceWriter extends STraceWriter {
	 ...
	 */
	@Override
	public void preregister(ISPassiveComponent component){
		tauWriter.defThread(component.getIdentifier().getID(), 0, component.getIdentifier().toString());
	}

	@Override
	public void startStateInternal(Epoch time, ISPassiveComponent comp,
			String eventDesc)
	{
	...
	@Override
	public void arrowStartInternal(Epoch time, ISPassiveComponent src,
	...
	@Override
	public void arrowEndInternal(Epoch time, ISPassiveComponent src,
			ISPassiveComponent tgt, long messageSize, int messageTag,
			int messageComm)
	{
		//endtime == now
	...
	private void addUsedComponent(ISPassiveComponent comp){
		usedCIDs.add(comp.getIdentifier());
	}

	@Override
	public void eventInternal(Epoch time, ISPassiveComponent comp,

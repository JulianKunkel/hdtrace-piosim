...
public class SimpleCPU extends ACPIDevice {

	@Override
	public void initComponentPowerConsumption() {

		BigDecimal[] statePowerConsumption = { new BigDecimal("100"),
				new BigDecimal("60"), new BigDecimal("10"),
				new BigDecimal("0.1") };
		...
		BigDecimal idlePowerConsumption = new BigDecimal("80");
		BigDecimal loadPowerConsumption = new BigDecimal("100");

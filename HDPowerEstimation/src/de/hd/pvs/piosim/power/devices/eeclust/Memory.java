...
public class Memory extends MemoryDevice {
	...
	public void initComponentPowerConsumption() {
		...
		// total memory size
		memorySize = new BigDecimal("12288");
		countBanks = 6;
		...
		this.getACPIComponent().setStateName(0, "SIX_BANKS_ACTIVE");
		this.getACPIComponent().setStateName(1, "THREE_BANK_ACTIVE");
		this.getACPIComponent().setStateName(2, "ONE_BANK_ACTIVE");

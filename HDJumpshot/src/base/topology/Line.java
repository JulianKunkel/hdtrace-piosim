...
public class Line
{
    ...
    */
                                     ...
                                     double final_time, float final_ypos )
    {
        ...
        jStart   = coord_xform.convertTimelineToPixel( start_ypos );
        jFinal   = coord_xform.convertTimelineToPixel( final_ypos );
    ...
    */
                                         ...
                                         double final_time, float final_ypos )
    {
        ...
        yStart   = (double) coord_xform.convertTimelineToPixel( start_ypos );

        xFinal   = (double) coord_xform.convertTimeToPixel( final_time );
        yFinal   = (double) coord_xform.convertTimelineToPixel( final_ypos );

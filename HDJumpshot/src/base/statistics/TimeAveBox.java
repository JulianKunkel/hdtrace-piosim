...
public class TimeAveBox extends TimeBoundingBox
{
    ...
    public void mergeWithReal( final DrawObjects  dobj )
    {
        Category          type;
        ...
        ave_num_real_objs  = overlap_duration / dobj.getDurationTime()
    ...
    public void mergeWithShadow( final Shadow  shade )
    {
        ...
        box_overlap_ratio  = (float) (overlap_duration / box_duration);
        sobj_overlap_ratio = overlap_duration / shade.getDurationTime();
    ...
    private void setRealDrawableExclusion()
    {
        ...
        Stack             nesting_stack;
        Iterator          dobjs_itr;
        DrawObjects          curr_dobj, stacked_dobj;
        ...
        while ( dobjs_itr.hasNext() ) {
            curr_dobj  = (DrawObjects) dobjs_itr.next();
            curr_dobj.initExclusion( timeblocks );
            while ( ! nesting_stack.empty() ) {
                stacked_dobj = (DrawObjects) nesting_stack.peek();

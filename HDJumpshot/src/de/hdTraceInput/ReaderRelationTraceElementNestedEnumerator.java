 ...
 */
public class ReaderRelationTraceElementNestedEnumerator extends ReaderRelationTraceElementEnumerator {

	// if null then the real object must be printed
	protected ForwardStateEnumeration stateChildEnumeration = null;

	public ReaderRelationTraceElementNestedEnumerator(ReaderRelationEnumerator relationEnum, Epoch startTime, Epoch endTime) {
		super(relationEnum, startTime, endTime);
	}

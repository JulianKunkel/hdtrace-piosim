...
mpicc -c -ggdb  -I/opt/hdf5/1.8.7-mpich2-1.4.1p1/include -DHDF5LIBS='"/opt/hdf5/1.8.7-mpich2-1.4.1p1/lib/libhdf5.so"' -I /opt/hdtrace/1.0/wrapper/include/  -I /opt/hdtrace/1.0/HDTraceWritingCLibrary/include/ -Wall ./wrapper.c -o wrapper-hdtracempi-hdf5-only.o -D HDTRACE  -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE  -ldl `pkg-config --libs glib-2.0 --cflags glib-2.0` || exit 1

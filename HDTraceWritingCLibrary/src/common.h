 ...
 */
#define hd_info_msg(format, ...) hd_X_msg("I", format, __VA_ARGS__)

/**
 * Print a formated debug message prefixed by "D:" and the code position
 */
#define hd_debug_msg(format, ...) hd_X_msg("D", format, __VA_ARGS__)

/**
 * Print a formated error message prefixed by "E:" and code position
 */
#define hd_error_msg(format, ...) hd_X_msg("E", format, __VA_ARGS__)

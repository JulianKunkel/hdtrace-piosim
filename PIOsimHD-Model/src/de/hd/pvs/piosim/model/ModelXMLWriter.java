...
public class ModelXMLWriter {
	...
	public void createXMLFromModel(Model model, StringBuffer sb) throws Exception{
		...
		for (BasicComponent com : model.getSwitches()) {
			createXMLFromComponent(com, sb);
		}
		sb.append("</SwitchList>\n\n");
	 ...
	 * @throws Exception
	 */
	public void createXMLFromComponent(BasicComponent component, StringBuffer sb) throws Exception{
	 ...
	 * @throws Exception
	 */
	private void createSubComponentXML(BasicComponent component, StringBuffer buff) throws Exception{
		Class<?> classIterate = component.getClass();	
	...
	/**
	 * Store the connection relation.
	 * @param connection
	 * @param buff
	 * @throws Exception
	 */
	private void createComponentAttributes(Connection connection, StringBuffer buff) throws Exception{
		if(connection.getConnectedComponent() != null){
			buff.append(" to=\"" + connection.getConnectedComponent().getIdentifier().getID() +  "\"");
		}
	}
	//////////////////////////////////////////////////////////////////////////////		
}

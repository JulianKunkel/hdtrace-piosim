...
public class ModelSortIDbySubcomponents extends ModelComponentSorter {
	...
	public void sort(Model model) {
		// new Map.
		HashMap<Integer, IBasicComponent> map = new HashMap<Integer, IBasicComponent>();
		...
		for(Node n: model.getNodes()){
			...
			ArrayList<IBasicComponent> list = n.getAllChildComponents();
			for(IBasicComponent bc: list){
				map.put(aktID++, bc);
			}
		}
